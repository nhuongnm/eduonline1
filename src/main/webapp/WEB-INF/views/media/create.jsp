...
<form class="form-horizontal" modelAttribute="user" method="post" accept-charset="utf8" enctype="multipart/form-data">
    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
    <legend><h4 class="text-danger">THÊM MỚI MEDIA</h4></legend>
    		File to upload: <input type="file" name="file">
    <div class="form-group">
        <label class="col-sm-2 control-label">Tên file</label>
        <div class="col-sm-5">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" placeholder="Loại" name="password">
        </div>
    </div>
    <div class="form-group">
