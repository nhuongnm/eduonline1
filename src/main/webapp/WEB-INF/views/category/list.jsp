...
<div class="form-group">
    <a href="<c:url value="/category/create"/>"><button type="button" class="btn btn-danger">Thêm</button></a>
</div>

<h4 class="text-danger text-center">DANH SÁCH CATEGORY</h4>
        ...
        <c:forEach items="${data}" var="value" varStatus="stt">     
            <tr>
                ...
                <td class="text-center">
                    <a href="<c:url value="/category/view/${value.id}"/>" rel="tooltip" title="xem">
